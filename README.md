...
## Environments
- Preview: https://main--addys--adsharma2910.aem.page/
- Live: https://main--addys--adsharma2910.aem.live/
...
1. Open the `addys` directory in your favorite IDE and start coding :)
